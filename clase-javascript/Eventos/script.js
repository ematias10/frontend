/* ============================================================
   script.js — Eventos en JavaScript
   Secciones:
...
// --- Botón doble click ---
const btnDoble = document.getElementById('btn-dobleclick');
...
const infoTecla    = document.getElementById('info-tecla');
...
formulario.addEventListener('submit', (e) => {
  ...
  formulario.reset();
  [inputNombre, inputRut, inputEdad].forEach(i => i.classList.remove('invalido'));
});
